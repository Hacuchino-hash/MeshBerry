/**
 * Unbound Meshberry Theme for device-ui
 *
 * Color Palette:
 * - Emerald (Brand): #50C878 = 0xff50C878
 * - Background: #0D1216 = 0xff0D1216
 * - Surface: #1E262D = 0xff1E262D
 * - Info Blue: #4FB6DB = 0xff4FB6DB
 * - Warning Amber: #D98A3A = 0xffD98A3A
 * - Text Primary: #ECEFF1 = 0xffECEFF1
 */
...
// Unbound Meshberry Theme Colors
// Dark theme (index 0), Light theme (index 1)
uint32_t themeColor[][2] = {
    // dark,       light
    {0xff0D1216, 0xfff4f4f4}, // eMainScreenStyle - Background #0D1216
    {0xff1E262D, 0xff50C878}, // eTopPanelBg - Surface #1E262D
    {0xffECEFF1, 0xff212121}, // eTopPanelText - Text Primary #ECEFF1
    {0xff1E262D, 0xff50C878}, // eTopImageBg - Surface
    {0xffffffff, 0xff212121}, // eTopImageRecolor
    {255, 255},               // eTopImageRecolorOpa
    {0xffffffff, 0xff212121}, // ePositiveImageRecolor,
    {0xff0D1216, 0xfff4f4f0}, // ePanelBg - Background
    {0xff1E262D, 0xfffafafa}, // ePanelPressedBg - Surface
    {0xffECEFF1, 0xff212121}, // ePanelText - Text Primary
    {0xff50C878, 0xff50C878}, // ePanelBorder - Emerald
    {0xff1E262D, 0xffffffff}, // eNodePanelBg - Surface
    {0xff808080, 0xff979797}, // eNodePanelBorder
    {0xffECEFF1, 0xff212121}, // eNodePanelText - Text Primary
    {0xff1E262D, 0xffffffff}, // eNodeButtonBg - Surface
    {0, 0},                   // eNodeButtonBgOpa
    {0xff1E262D, 0xffffffff}, // eButtonPanelBg - Surface
    {0xff1E262D, 0xffeaeae0}, // eMainButtonBg - Surface
    {0xffECEFF1, 0xff101010}, // eMainButtonText - Text Primary
    {0xff50C878, 0xff50C878}, // eMainButtonBorder - Emerald
    {0xff0D1216, 0xffc0c0c0}, // eMainButtonShadow - Background
    {0xff50C878, 0xff757575}, // eMainButtonImageRecolor - Emerald
    {0, 255},                 // eMainButtonImageRecolorOpa
    {0xff0D1216, 0xfffafaf4}, // eHomeContainerBg - Background
    {0xff50C878, 0xffaaaaaa}, // eHomeContainerBorder - Emerald
    {0xff1E262D, 0xff999999}, // eHomeContainerShadow - Surface
    {0xffECEFF1, 0xff294337}, // eHomeContainerText - Text Primary
    {0xff0D1216, 0xffffffff}, // eHomeButtonBg - Background
    {0xffffffff, 0xff101010}, // eHomeButtonText
    {0xff0D1216, 0xffd0d0d0}, // eHomeButtonBorder - Background
    {0xff606060, 0xff4FB6DB}, // eHomeButtonImageRecolor - Info Blue for light
    {0, 255},                 // eHomeButtonImageRecolorOpa
    {0xff1E262D, 0xfffafaf4}, // eChannelButtonBg - Surface
    {0xffA0A0A0, 0xffD0D0D0}, // eChannelButtonBorder
    {0xffffffff, 0xff101010}, // eChannelButtonText
    {0xff0D1216, 0xfff0f0f0}, // eSettingsPanelBg - Background
    {0xffECEFF1, 0xff003c9f}, // eSettingsPanelText - Text Primary
    {0, 0xff979797},          // eSettingsPanelBorder
    {0, 0xff7e7e7e},          // eSettingsPanelShadow
    {250, 250},               // eSettingsPanelBgOpa
    {0xff1E262D, 0xffeaeae0}, // eSettingsButtonBg - Surface
    {0xffECEFF1, 0xff294337}, // eSettingsButtonText - Text Primary
    {0xff0D1216, 0xffd0d0d0}, // eSettingsButtonBorder - Background
    {0, 0xff50C878},          // eSettingsButtonImageRecolor - Emerald
    {0, 255},                 // eSettingsButtonImageRecolorOpa
    {0xff1E262D, 0xffffffff}, // eSettingsLabelBg - Surface
    {0xff1E262D, 0xff808080}, // eSettingsLabelBorder - Surface
    {0xff0D1216, 0xfff4f4f4}, // eTabViewBg - Background
    {0xffECEFF1, 0xff003c9f}, // eTabViewText - Text Primary
    {0xff0D1216, 0xffe0e0e0}, // eTabButtonDefaultBg - Background
    {0xff0D1216, 0xffffffff}, // eTabButtonActiveBg - Background
    {0xff50C878, 0xffECEFF1}, // eTabButtonPressedBg - Emerald
    ...
    {0xff1E262D, 0xffb0b0b0}, // eTabButtonDefaultBorder - Surface
    {0xff0D1216, 0xfffbfce9}, // eChatMessageBg - Background
    {255, 255},               // eChatMessageBgOpa
    {0xffffffff, 0xff294337}, // eChatMessageText
    {0xff1E262D, 0xff888888}, // eChatMessageBorder - Surface
    {0xff1E262D, 0xffffffff}, // eNewMessageBg - Surface
    {255, 255},               // eNewMessageBgOpa
    {0xffd0d0d0, 0xff294337}, // eNewMessageText
    {0xff808080, 0xff888888}, // eNewMessageBorder
    {0xff0D1216, 0xfffbfbfb}, // eAlertPanelBg - Background
    {0xff0D1216, 0xfff4f4f4}, // eBtnMatrixBorderMain - Background
    {0xff50C878, 0xff50C878}, // eBtnMatrixBorderItems - Emerald
    {0xff1E262D, 0xfffffff8}, // eBtnMatrixBgItems - Surface
    {0xffECEFF1, 0xff212121}, // eBtnMatrixTextItems - Text Primary
    {0xffECEFF1, 0xff212121}, // eBatteryPercentageText - Text Primary
    {0xffECEFF1, 0xff003c9f}, // eColorTextLabel - Text Primary
    {0xff1E262D, 0xffe0e0e0}, // eSpinnerMainArc - Surface
    {0xff50C878, 0xff50C878}, // eSpinnerIndicatorArc - Emerald
    {0xffECEFF1, 0xff212121}, // eTableHeadingText - Text Primary
    {0xff0D1216, 0xfff4f4f0}, // eTableHeadingBg - Background
    {0xffECEFF1, 0xff212121}, // eTableItemText - Text Primary
    {0xff1E262D, 0xfff4f4f0}, // eTableItemBg - Surface
    {0xff0D1216, 0xffd4d4d0}, // eTableItemDarkBg - Background
    {0xff1E262D, 0xffe0e0e0}, // eTableBorder - Surface
    {0xff1E262D, 0xffe0e0e0}  // eTableCellBorder - Surface
};
...
void Themes::initStyles(void)
{
    ...
    lv_style_set_border_color(&style_btn_active, lv_color_hex(0xff50C878)); // Emerald
    ...
    lv_style_set_border_color(&style_btn_pressed, lv_color_hex(0xff50C878)); // Emerald
...
void Themes::recolorTopLabel(lv_obj_t *obj, bool alert)
{
    ...
    switch (theme) {
    case eLight:
        color = alert ? lv_color_hex(0xffD98A3A) : lv_color_hex(THEME(eTopPanelText)); // Warning Amber
        break;
    case eDark:
        color = alert ? lv_color_hex(0xffD98A3A) : lv_color_hex(THEME(eTopPanelText)); // Warning Amber
        break;
